            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                foreach($students as $student){ ?>
                  <tr>
                    <td><?php echo $i ?></td>
                    <td class="sbd-td"><?php echo $student['sbd'] ?></td>
                    <td class="fullname-td"><?php echo $student['fullname'] ?></td>
                    <td class="birthday-td"><?php echo date('d/m/Y',strtotime($student['birthday'])) ?></td>
                    <td class="gender-td"><?php echo $student['gender'] ?></td>
                    <td><?php echo $student['class'] ?></td>
                    <td><?php echo $student['school_name'] ?></td>
                    <td><?php echo $student['venue_name'] ?></td>
                   
                    <td>
                    <button class="btn btn-warning updatestudent" student-id="<?php echo $student['id'] ?>">Cập nhật</button>
                    <a href="<?php echo base_url() ?>studentcard_controller/export_custom_card<?php echo '/'.$student['id'] ?>"><button class="btn btn-success">PDF</button></a>
                     </td>
                  </tr>
                 <?php  $i++;} ?>
                </tbody>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Cập nhật thông tin thí sinh</h4>
      </div>
      <div class="modal-body">
         <form class="form-horizontal">
          <div class="form-group">
    <label class="control-label col-sm-2" for="sbd">SBD</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="button" class="btn btn-default" id="submitUpdate">Submit</button>
    </div>
  </div>
</form>
      </div>
