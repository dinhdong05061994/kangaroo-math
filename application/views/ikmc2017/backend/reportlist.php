...
<head>
  ...
  <title>IKMC2017 Administrator </title>
    ...
    <section class="content">
      <div class="row">
        ...
        <!--   <div class="box">
          ...
          <div class="box">
            <div class="box-header">
              <h2 class="box-title">Danh sách thí sinh báo lỗi tra cứu</h2>
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                foreach($reports as $report){ ?>
                  <tr>
                    ...
                    <td><?php echo $report['student_birthday'] ?></td>
                    <td><?php echo $report['schoolname'] ?></td>
                    <td><?php echo $report['classroom'] ?></td>
                    <td><?php echo $report['student_phone_number'] ?></td>
                    <td><?php echo $report['student_email'] ?></td>
                    <td><?php echo $report['error_content'] ?></td>
                    <td><?php echo $report['sent_date'] ?></td>
                    <td class="note-td" style="background-color: #f9f74f;"><?php echo $report['note'] ?></td>
                    <td><button class="btn btn-primary btnNote" data-id="<?php echo $report['id'] ?>">Note</button><br>
                    <button class="btn btn-danger btnDelReport" data-report-id="<?php echo $report['id'] ?>">Xóa</button></td>

                    <td>
                    
                    <?php if($report['state']!=0){ ?>
                    <span class="label label-success report-state" report-id="<?php echo $report['id'] ?>" current-state="1">Đã xử lý</span>
                     <?php }else{ ?>
                     <span class="label label-warning report-state" report-id="<?php echo $report['id'] ?>" current-state="0">Chưa xử lý</span>
                    <?php  } ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Viết ghi chú</h4>
      </div>
      <div class="modal-body">
         <form class="form-horizontal">
    
  <div class="form-group">
    <label class="control-label col-sm-2" for="fullname">Ghi chú</label>
    <div class="col-sm-10">
    <input type="hidden" name="reportid" id="reportid">
      <textarea class="form-control" name="note_content" id="note_content"></textarea>
    </div>
  </div>

  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="button" class="btn btn-default" id="submitNote">Submit</button>
    </div>
  </div>
</form>
      </div>
...
<!-- AdminLTE App -->
<script src="<?php echo base_url() ?>admin_plugin/dist/js/app.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo base_url() ?>admin_plugin/dist/js/demo.js"></script>
<!-- page script -->
 <script src="<?php echo base_url() ?>ikmc2017_assets/sweetalert/dist/sweetalert.min.js"></script>
  <script src="<?php echo base_url() ?>ikmc2017_assets/js/ikmc2017_backend.js"></script>
<script>
  $(function () {
