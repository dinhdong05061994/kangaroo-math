...
<h2 class="page-title">Gửi thông báo lỗi tra cứu</h2>
	...
	<section class="form-container">
		...
		<div class="col-sm-4 col-xs-12 col-md-offset-3 contactus-part">
		  <form action="<?php echo base_url(); ?>student/search/error/report" method="post" class="error-report">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="text" class="form-control" id="classroom" name="classroom" placeholder="Lớp" required="">
    </div>
     <div class="form-group">
      <label for="birthday">Trường</label>
      <select class="form-control select2" name="school" id="school">
       ...
       <div class="form-group">
      <label for="phone">SĐT Phụ huynh</label>
      <input type="text" class="form-control" id="phone" name="phone" placeholder="Số điện thoại">
    </div>
     <div class="form-group">
      <label for="classroom">Email phụ huynh</label>
      <input type="text" class="form-control" id="email" name="email" placeholder="Email" required="">
    </div>
     <div class="form-group">
      <label for="error_content">Nội dung lỗi gặp phải</label>
