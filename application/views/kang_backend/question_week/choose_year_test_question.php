		...
		<ul class= "name_user">
			...
			<?php $session_id = $this->session->userdata('admin');
    			...
    			<ul class="choose" style = "width:130px; margin:5px 0;">
                    <li><a href = "<?php echo base_url();?>index.php/kang_admin_week/change_pass">Đổi mật khẩu</a></li>
                    <!-- <li><a href = "<?php echo base_url()?>index.php/kang_admin/choose_year_question">Hệ thống quản lý câu hỏi</a></li> -->
                    <br/>
                    <li><a href = "<?php echo base_url();?>index.php/kang_admin_week/view_test_question_table">Trang Chủ</a></li>
                </ul>
			</li>
...
<div id="wrapper" class="wrapper">  
    ...
    <form method="post" action="<?php echo base_url();?>index.php/kang_admin_week/add_test_question/" id="add_test_question_frm">
        <fieldset>
		...
		<?php
            ...
            <button type="submit" class="btn btn-default" formaction="<?php echo base_url();?>index.php/kang_admin_week/view_test_question_table/">Xem bảng câu hỏi</button>
        </fieldset>
    </form>
    </div>
