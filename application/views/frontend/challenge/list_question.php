...
<script>
...

    {
        ...
        console.log(str_string);
                            ...
                            url: "challenge/insert_record_test",
...
<!-- <body  onselectstart="return false" oncontextmenu="return false">   -->
    ...
    font-family: Arial, Helvetica, sans-serif;">
            ...
            <div class="q_done_button btn" id = "go_back_after_submit" style="display: none; cursor: pointer;">
                <div onclick="javascript: window.location.href='<?php echo base_url();?>challenge';" style="height: 20px; width: 200px;    color: #fff;text-align: center; padding: 5px;border-radius: 7px;
        margin-left: 100px;
        ...
        border-color: #4cae4c;"><?php echo $lang =='vi'? "Quay lại" : 'Go back'?></div>
            ...
            <div class="q_list-question">      
                ...
                <?php  
                    echo (isset($message_num_quetions) ? '<div id = "info-send" class="alert alert-info" style="font-size:16px; text-align:center;width: 92%; ">'.$message_num_quetions.'</div><div id = "close_msg" style="position:absolute;right: 0; margin-right: 5%; margin-top: -85px;color: #31708f;">&times;</div>' : "");?>
    ...
    font-family: Arial, Helvetica, sans-serif;">
                                ...
                                ?>
                                            <div class="q_answer_line">
                                                <!--<div class="q_answer_radio">-->
                                                    <input type="radio" name="Cau<?php echo $i; ?>" id="Cau<?php echo $i."_".$k; ?>" value="<?php echo $k; ?>"/> 
                                                <!--</div>-->
                                                ...
                                                ?>
                                                        <div class="q_answer_text">
                                                            <?php echo $ans_content; ?> <?php echo $j == $k ? "<img id='dapandung_".$i."' src='".base_url()."images/test_question/dung.png' style='    width: 20px;
    margin-top: -23px;
    margin-left: -23px;
    display:none;'>":""   ?>                                                        </div>
                                                <?php
        ...
        <div class="q_done_button btn" id="q_done_button" >
            <div onclick="CheckDapAn();" style="height: 20px; width: 200px;    color: #fff;text-align: center; padding: 5px;border-radius: 7px;
    margin-left: 100px;
    background-color: #5cb85c;
