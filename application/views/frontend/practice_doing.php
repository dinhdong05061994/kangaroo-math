...
<script>
    ...
    function submit_form()
    {
        ...
        for(i = 1; i <= num_question; i++)
        {
            ...
            if(type == 1){
                ...
                if(right_ans != 0){
                    ...
                    {
                        if(index_checked > 0) mark_sub += parseInt(m);
                ...
                if( user_ans == right_ans)
                {
                    ...
                    if(user_ans != "") mark_sub += parseInt(m);
                    result_test_record += "0,";
                    document.getElementById('order_view_' + i).style.background = "rgb(250, 0, 0)";
                }
        ...
        document.getElementById('num_wrong_ans').innerHTML = (num_question - num_right_ans) + "/" + num_question;
...
<body>
    ...
    <div class="container">
    	<div class="row">
			<section  style="margin-left: 20px; margin-right:20px ;"class="row ct">
           	<!--End .Nav-->
                <form name="form" id="form">
                    <div class="result_test" id="result_test" hidden="" >
                        <div class="info_line">
                            <?php echo $arg['points'];?>: 
           ...
           //alert($(document).height() + "-" + screen.height + "=" + (aboveHeight - screen.height) + "<>" + $(window).scrollTop());
            ...
            $('.submit_form').css('position','fixed').next().css('bottom','0px');
             //alert($(window).scrollTop() + "+" + aboveHeight);
                ...
                $('.submit_form').css('position','relative').next().css('bottom','0px');
