...
<section style="margin-bottom: 35px;" class="main-content-lt container-fluid container-1">
    <section class="col-sm-3">
        <section class="col-sm-12 img-member bieudo">
            ...
            <section style="height: 600px; overflow: auto;" class="col-sm-12 main-content-right clearfix">
                <ol>
                    ...
                    <?php    }else{    ?>
                    <li onclick="get_para(<?php echo $lecture['id']; ?>);"><a class="lecture_item"><?php echo $lecture['name']; ?></a></li>
                   <?php }
                    endforeach; ?>
            ...
            <script>
                    $(document).ready(function() {
                        var para_id = document.getElementById("min_lecture").innerHTML;
                        get_para(para_id);
