...
<section class="main-content-lt container-fluid container-1">
    ...
    <section class="col-sm-6">
        ...
        <section class="col-sm-10 main-content-right clearfix">
            <ul>
		<li style="list-style:none;<?=$total_question_monthly <=0 ? 'background: #ccc;padding: 3px;':'';?>"><img width="35px" height="35px;" src="img/tt.png" /><a <?=$total_question_monthly <=0 ? 'onclick="return false;" style="text-decoration: none;cursor: not-allowed;"':'';?> href="<?php echo base_url() . 'competition_month' ?>"><?php echo $lang=="en" ? 'August exam' : 'Bài thi tháng 8';?></a><?=$total_question_monthly <=0 ? ' <i>(coming soon)</i>':'';?></li>
                 <li style="margin-left:35px;"><a href="<?php echo base_url() . 'competition_month/rank' ?>"><?php echo $lang=="en" ? 'Month Competition Ranking' : 'Bảng xếp hạng kỳ thi tháng';?></a></li>
                <li style="margin-left:35px;<?=$total_question_week <=0 ? 'background: #ccc;padding: 3px;':'';?>"><a <?=$total_question_week <=0 ? 'onclick="return false;" style="text-decoration: none;cursor: not-allowed;"':'';?> href="<?php echo base_url() . 'summer/load_level/0' ?>"><?php echo $lang=="en" ? 'Weekly Challenge' : 'Thử thách hàng tuần';?></a><?=$total_question_week <=0 ? ' <i>(coming soon)</i>':'';?></li>
...
// line chart data
                    ...
                    function change_infor_user() {
                        ...
                        } else if (change_name.lastIndexOf("<") != -1 || change_name.lastIndexOf('>') != -1) {
                        ...
                        } else if (!phone.match(/^[0-9]+$/) && phone != "") {
                            check = false;
                            erorr += "<i>Phone number</i> chỉ được nhập số.</br>";
                        } else if ((phone.length > 12 || phone.length < 9) && phone != "") {
                            check = false;
